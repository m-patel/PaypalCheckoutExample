/*
 * This is a C# code file named PaypalClient.cs.
 * It contains the implementation of a Paypal client class that handles authentication and performs operations such as creating and capturing orders.
 */
...
// Authenticates the client and returns the authentication response
...
// Creates an order with the specified value, currency, and reference
...
// Captures an order with the specified orderId
...
// Represents the response of creating an order
...
// Represents the response of capturing an order
...
// Represents seller receivable breakdown
